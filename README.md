...
dbt Signal Brief turns dbt operating evidence into board-ready exposure, savings, investment, and narrative decisions.

## What it answers

Can leadership explain where dbt creates exposure, savings opportunity, investment priority, or board-visible execution risk?
...
- **Ingest:** Collect dbt operating evidence without exposing credentials or raw customer data.
...
- dbt exposure and ownership map
...
- [GitHub repo](https://github.com/mizcausevic-dev/dbt-model-governance-auditor)
